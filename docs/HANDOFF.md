...
- `npm run test:all` passed 377 assertions plus the stress suite. Claude and Codex read-only
  status checks against ApplyPilot both stayed unloaded and reported the sensitive-file block.
